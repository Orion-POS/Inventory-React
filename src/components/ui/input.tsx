    ...
    return (
      <div className="text-sm font- relative flex flex-col gap-2  ">
        <input
          type={type}
          className={cn(
            'flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-brand-400 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-100 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:bg-[#E5E5E5]',
            className
          )}
          ref={ref}
          {...props}
