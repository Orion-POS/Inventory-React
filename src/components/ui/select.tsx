...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDownOutline className="h-4 w-4 opacity-50 text-black" />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full SelectItem cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    )}
    {...props}>
