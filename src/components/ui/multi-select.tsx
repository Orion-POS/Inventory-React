...
import { CheckIcon, ChevronDown, Sparkles as WandSparkles, XCircle, XIcon } from 'lucide-react';
      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            {selectedValues.length > 0 && renderAs === 'checkbox' ? (
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-sm text-muted-foreground mx-3">
                  {selectedValues.length > 0 && renderAs === 'check-only'
              ...
              <CommandGroup>
                <div className="flex items-center justify-between">
                  ...
                  {overrideCloseButton === null ? (
                    ...
                    <CommandItem>{overrideCloseButton}</CommandItem>
                  )}
                </div>
              </CommandGroup>
            </CommandList>
